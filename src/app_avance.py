...
.custom-card .list-item { font-size: 12px; color: var(--muted); margin-top: 4px; display: flex; justify-content: space-between;}
...
.district { padding: 17px 8px; border-radius: 12px; text-align: center; font-size: 11px; font-weight: 700; border: 1px solid rgba(255,255,255,.08); }
...
.metric { background: #0d2936; border: 1px solid #1a4e61; border-radius: 12px; padding: 12px; font-size: 12px;}
